/*! tooltipster v4.0.0 */ !(function (a, b) {
  ...
  function d(b) {
    var c = "string" == typeof b ? b : b.attr("id");
    return c
      ? !!h.window.document.getElementById(c)
      : a.contains(h.window.document.body, b[0]);
  }
  function e() {
  ...
  var f = {
    ...
    h = {
      hasTouchCapability: !!(
        "ontouchstart" in g ||
        (g.DocumentTouch && document instanceof DocumentTouch) ||
        ...
        for (
          b._trigger({
            ...
            k.origin.offset.left =
              k.origin.windowOffset.left + h.window.scrollX,
            k.origin.offset.top = k.origin.windowOffset.top + h.window.scrollY,
      ...
      __trackerStart: function () {
        ...
        return (
          ...
          (a.__tracker = setInterval(function () {
            if (d(a._$origin) && d(a.__namespace)) {
              ...
              var l = function () {
                clearInterval(d.__tracker),
                  ...
                  d.__options.functionAfter &&
                    d.__options.functionAfter.call(d, d, { event: b }),
                  f();
              };
              h.hasTransitions
                ? (d._$tooltip.css({
    ...
    (b.prototype = {
      ...
      measure: function () {
        ...
        var a = this.__$tooltip[0].getBoundingClientRect(),
          b = { size: { height: a.bottom, width: a.right } };
        if (this.constraints) {
